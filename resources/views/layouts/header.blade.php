...
<head>
	...
	<link href="{{ asset('') }}rocker_admin/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" />
	...
	<!-- Theme Style CSS -->
	<link rel="stylesheet" href="{{ asset('') }}rocker_admin/assets/css/dark-theme.css" />
	<link rel="stylesheet" href="{{ asset('') }}rocker_admin/assets/css/semi-dark.css" />
	<link rel="stylesheet" href="{{ asset('') }}rocker_admin/assets/css/header-colors.css" />
    @stack('css')
    @stack('styles')
	<title>Universitas Muhammadiyah Kota Jambi</title>
</head>
