                        ...
                        <form action="{{ route($link . '.update',$data->nik) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 col-sm-12 mb-10">
                                <div class="container text-center">
                                    ...
                                    <div class="wrapper">
                                        <div class="image">
                                            <img class="img-phasfoto" src="{{ Storage::url('public/mahasiswas/').$data->gambar }}" alt="">
                                        </div>
                                        <div class="content">
                                            <div class="icon">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="{{ $data->jalurpendaftaran->nama_jalur_pendaftaran }}">{{ $data->jalurpendaftaran->nama_jalur_pendaftaran }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama"
                                        ...
                                        placeholder="Nama Lengkap Sesuai Ijazah" value="{{ old('nama') ?? $data->nama_mahasiswa}}">
                                    @if ($errors->has('nama'))
                                    <div class="text-danger">
                                        {{ $errors->first('nama') }}
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="birthday"
                                                ...
                                                onmouseout="timeFunctionLong(this)" value="{{ old('tanggal_lahir') ?? $data->tanggal_lahir }}">
                                            <script>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="jenis_kelamin"
                                                ...
                                                <option value="{{ $data->jeniskelamin->id }}">{{ $data->jeniskelamin->name }}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="agama"
                                                ...
                                                <option value="{{ $data->agama()->first()->id }}">{{ $data->agama()->first()->name }}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="ayah" placeholder="Nama Ayah/Wali" value="{{ old('ayah') ?? $data->nama_ayah }}">
                                            @if ($errors->has('ayah'))
                                            <div class="text-danger">
                                                {{ $errors->first('ayah') }}
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="ibu" placeholder="Nama Ibu" value="{{ old('ibu') ?? $data->nama_ibu }}">
                                            @if ($errors->has('ibu'))
                                            <div class="text-danger">
                                                {{ $errors->first('ibu') }}
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="jenis_sekolah"
                                                ...
                                                <option value="{{ $data->jurusan_sekolah }}">{{ $data->jurusan_sekolah }}
                                                </option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('jurusan') ?? $data->jurusan_sekolah }}" name="jurusan" placeholder="Jurusan">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="{{ $data->program_kuliah->id_program_kuliah }}">{{ $data->program_kuliah->nama_program_kuliah }}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="prodi1"
                                                ...
                                                <option value="{{ $data->prodi1()->first()->nama_prodi }}">{{ $data->prodi1()->first()->nama_prodi }}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="prodi2"
                                                ...
                                                <option value="{{ $data->prodi2 }}">{{ $data->prodi2()->first()->nama_prodi }}</option>
                                                @foreach ($prodi as $item)
                                                <option value="{{ $item->id_prodi }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="pekerjaan"
                                                placeholder="Nama Instansi" value="{{ old('pekerjaan') ?? $data->nama_instansi }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="info_kuliah"
                                        ...
                                        id="informasi_kuliah">
                                        <option value="{{ $data->informasi_kuliah }}">{{ $data->informasikuliah()->first()->nama }}</option>
