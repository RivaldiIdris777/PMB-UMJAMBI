        ...
        <div class="row">
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{ route($link . '.store', $data->nik) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12 col-sm-12">
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <div class="form-group mt-5">
                                    ...
                                    <small>* Dokumen Wajib Terdiri dari ( KTP, Ijazah, KK,  SKL, SKHU, Phas Foto )</small> <br />
                                    <small>* Jika mahasiswa pindahan terdiri dari Ijazah SMA, SKHU, KK, KTP, Pas Foto, Surat Pindah Universitas, Scan Salinan yang disahkan PTS/PTN (IPK Min 3,00 untuk PTS dan 2,75 untuk PTN), Scan Akreditasi Prodi Kampus Asal.</small> <br />
                                    <small>* Mahasiswa pindahan terdiri dari Ijazah SMA, SKHU, KK, KTP, Pas Foto, Ijazah D3/S1, Transkrip Nilai</small><br />
                                    <small>* Mahasiswa Pascasarjana (S2) terdiri dari Ijazah SMA, Scan SKHU / Nilai UN /Surat Keterangan Lulus /Daftar Nilai Ijazah, Scan Kartu Keluarga, Scan Kartu Tanda Penduduk, Scan Pas Foto Warna (Ukuran 4x6), Scan Ijazah S1, Scan Transkip Nilai S1 </small>
                                </div>
                                <div class="form-group mt-5">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <select name="status_kelengkapan" class="form-control {{ count($errors) > 0 ? ($errors->has('status_kelengkapan') ? 'is-invalid' : 'is-valid') : '' }}">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <textarea class="form-control {{ count($errors) > 0 ? ($errors->has('keterangan') ? 'is-invalid' : 'is-valid') : '' }}" name="keterangan" cols="30" rows="5"></textarea>
