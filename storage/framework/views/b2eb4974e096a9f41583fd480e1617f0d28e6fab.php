    ...
    <div class="col-12">
        ...
        <div class="card radius-10">
            <div class="card-body">
                ...
                <a href="<?php echo e(url('export_gelombang1')); ?>" class="btn btn-success">
                    Export Gelombang Pertama
                </a>
                <a href="<?php echo e(url('export_gelombang2')); ?>" class="btn btn-success">
                    Export Gelombang Kedua
                </a>
                <a href="<?php echo e(url('export_gelombang3')); ?>" class="btn btn-success">
                    Export Gelombang Ketiga
                </a>
                <a href="<?php echo e(url('export_gelombang4')); ?>" class="btn btn-success">
                    Export Gelombang Keempat
                </a>
                <a href="<?php echo e(url('export_gelombang5')); ?>" class="btn btn-success">
        ...
        <div class="card radius-10">
            <div class="card-body">
                ...
                <form action="<?php echo e(url('filtertanggal')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
        ...
        <div class="card radius-10">
            <div class="card-body">
                ...
                <a href="<?php echo e(url('export_prodi_informatika')); ?>" class="btn btn-success">
                    Export Prodi Informatika
                </a>
                <a href="<?php echo e(url('export_prodi_sistem_informasi')); ?>" class="btn btn-success">
                    Export Prodi Sistem Informasi
                </a>
                <a href="<?php echo e(url('export_prodi_ekonomi_pembangunan')); ?>" class="btn btn-success">
                    Export Prodi Ekonomi Pembangunan
                </a>
                <a href="<?php echo e(url('export_prodi_manajemen')); ?>" class="btn btn-success">
                    Export Prodi Manajemen
                </a>
                <a href="<?php echo e(url('export_prodi_kehutanan')); ?>" class="btn btn-success">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Folder_project\Laravel_project\pmbmahasiswa\resources\views/admins/exportexcel/mahasiswa2.blade.php ENDPATH**/ ?>