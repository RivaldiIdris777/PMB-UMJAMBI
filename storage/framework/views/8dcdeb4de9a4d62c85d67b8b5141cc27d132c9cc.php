...
<head>
    <title><?php echo e($data->no_registrasi); ?></title>
    <style type="text/css">
        @page {
            margin-top: 1em;
        }
...
<body>
    ...
    <table border="0"
        ...
        <tr>
            <td><img src="data:image/png;base64, <?php echo e($default['logo_um']); ?>" width="70px"></td>
            ...
            <td><img src="data:image/png;base64, <?php echo e($default['logo_pmb']); ?>" width="85px"></td>
        </tr>
    </table>
    ...
    <table border="0"
        ...
        <tr>
            ...
            <td>:</td>
            <td><b><?php echo e($data->no_registrasi); ?> </b></td>
        </tr>
        <tr>
            <td>2.</td>
            <td>JALUR MASUK</td>
            <td>:</td>
            <td><?php echo e(Str::ucfirst(Str::lower($data->jalurmasuk()->first()->nama_jalur_pendaftaran))); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>JENIS KELAMIN</td>
            <td>:</td>
            <td><?php echo e($data->jenis_kelamin == 1 ? 'Laki-Laki' : 'Perempuan'); ?></td>
        </tr>
        <tr>
            <td>7.</td>
            <td>AGAMA</td>
            <td>:</td>
            <td><?php echo e(Str::ucfirst(Str::lower($data->agama()->first()->name))); ?></td>
        </tr>
        <tr style="vertical-align: top;">
            <td valign='top'>8.</td>
            <td valign='top'>ALAMAT</td>
            <td valign='top'>:</td>
            <td><?php echo e($data->jalan ? 'Jalan ' . $data->jalan : ''); ?>
                ...
                <?php echo e($default['prov'] ? ', ' . Str::title(Str::lower($default['prov']))  : ''); ?></td>
        </tr>
        <tr>
            <td>9.</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td><span
                    style="border: 1px solid black; border-radius:2px ; padding: 0px 5px 0px 5px; margin-right: 15px"><?php echo e($data->id_asal_sekolah); ?></span>
                ...
                <table
                    ...
                    <tr>
                        <td>
                            ...
                            <img src="data:image/png;base64, <?php echo e($default['ceklis']); ?>" width="15px" height="15px">
                            <?php else: ?>
                            <img src="data:image/png;base64, <?php echo e($default['kotak']); ?>" width="15px" height="15px">
                            <?php endif ?>
                        </td>
                ...
                <table style="width:100%; border: 1px solid black; text-align: left ;">
                    <tr>
                        ...
                        <td style="width: 18px;">
                            ...
                            <img src="data:image/png;base64, <?php echo e($default['ceklis']); ?>" width="15px"
                                height="15px">
                            <?php else: ?>
                            <img src="data:image/png;base64, <?php echo e($default['kotak']); ?>" width="15px" height="15px">
                            <?php endif ?>
        ...
        <tr>
            ...
            <td>
                ...
                <img style="position: absolute; float: left; padding-right: 5px;"
                    src="data:image/png;base64, <?php echo e($default['ceklis']); ?>" width="15px">
                <?php else: ?>
                <img style="position: absolute; float: left; padding-right: 5px;"
                    src="data:image/png;base64, <?php echo e($default['kotak']); ?>" width="15px">
                <?php endif ?>
        ...
        <tr>
            <td colspan="4"
                ...
                <?php echo e($default['tanggal_formulir']); ?></td>
        </tr>
        <tr>
            <td colspan="4">
...
<?php /**PATH C:\laragon\www\Folder_project\Laravel_project\pmbmahasiswa\resources\views/cetak/template-formulir.blade.php ENDPATH**/ ?>