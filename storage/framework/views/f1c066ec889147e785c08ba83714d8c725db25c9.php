        ...
        <div class="card radius-10">
            <div class="card-body">
                <div>
                    ...
                    <form action="<?php echo e(route($link . '.storeMahasiswa')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Folder_project\Laravel_project\pmbmahasiswa\resources\views/users/mahasiswa/add.blade.php ENDPATH**/ ?>