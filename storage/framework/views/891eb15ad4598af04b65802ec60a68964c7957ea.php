        ...
        <div class="card radius-10">
            <div class="card-body">
                <div>
                    ...
                    <form action="<?php echo e(route($link . '.update', $agama->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="form-group">
                            <label for="name">Nama Agama</label>
                            <input type="text" name="name" class="form-control" value="<?php echo e($agama->name); ?>">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <select name="status" id="status" class="form-control">
                                <option value="<?php echo e($agama->status); ?>"><?php echo e($agama->status); ?> (Pilihan Sebelumnya) </option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Folder_project\Laravel_project\pmbmahasiswa\resources\views/admins/agama/edit.blade.php ENDPATH**/ ?>