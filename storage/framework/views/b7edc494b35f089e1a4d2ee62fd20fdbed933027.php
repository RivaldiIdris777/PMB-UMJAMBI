...
<head>
    ...
    <title>Send Reset Password - Universitas Muhammadiyah Kota Jambi</title>
</head>
                        ...
                        <div class="card mt-5 mt-lg-0">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="text-center"> <span>KIRIM RESET PASSWORD</span>
                                        <hr />
                                        ...
                                        <div class="form-body">
                                            <form class="row g-3" method="POST" action="<?php echo e(route('reset.send')); ?>">
                                                <?php echo csrf_field(); ?>
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="d-grid">
                                                        <button type="submit" class="btn btn-primary"><i
                                                                class="bx bxs-lock-open"></i>Kirim Reset
                                                            Password</button>
                                                    </div>
                                                </div>
