...
<body style="background-color: #fff; margin: 0; padding: 20px; -webkit-text-size-adjust: none; text-size-adjust: none;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th class="column"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div align="center" style="line-height:10px"><img
                                                                        src="https://raw.githubusercontent.com/RivaldiIdris777/PMB-UMJAMBI/main/public/logo_um.png  "
                                                    ...
                                                    <table border="0" cellpadding="10" style="margin-top: 10px;"
                                                        cellspacing="0" class="text_block" role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;"
                                                        width="100%">
                                                        <tr>
                                                    ...
                                                    <table border="0" style="margin-top: 10px;" cellpadding="10"
                                                        cellspacing="0" class="button_block" role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                                        width="100%">
                                                        <tr>
                                                            <td>
                                                                <div align="center">
                                                                    <a href="<?php echo e(url('/resetpassword/' .$user->email)); ?>"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        style="color: #717171; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p
                                                                            style="margin: 0; font-size: 12px; text-align: center;">
                                                                            © 2023-2024 Universitas Muhammadiyah. All Right Reserved
                                                                            Jl. Kapten Pattimura, Simpang IV Sipin, Kec. Telanaipura,
...
<?php /**PATH C:\laragon\www\Folder_project\Laravel_project\pmbmahasiswa\resources\views/emails/confirm-resetpassword.blade.php ENDPATH**/ ?>