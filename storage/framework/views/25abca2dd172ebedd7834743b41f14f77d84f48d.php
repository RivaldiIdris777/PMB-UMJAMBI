                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button
                                    class="btn <?php echo e($ktp->ktp_status == 'Y' ? 'btn-success' : 'btn-danger'); ?>"><?php echo e($ktp->ktp_status); ?></button>
                            </td>
                            <td><?php echo e($ktp->admin()->first()->name); ?></td>
                            <td style="text-align:right;">
                                <form action="<?php echo e(route('dokumenmahasiswa.validasiktp', $dokumen[0]->nik)); ?>"
                                    method="POST">
                                ...
                                <form action="<?php echo e(route('dokumenmahasiswa.tolakvalidasiktp', $dokumen[0]->nik)); ?>"
                                    method="POST">
                                    <?php echo e(csrf_field()); ?>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button
                                    class="btn <?php echo e($kk->kk_status == 'Y' ? 'btn-success' : 'btn-danger'); ?>"><?php echo e($kk->kk_status); ?></button>
                            </td>
                            <td><?php echo e($ktp->admin()->first()->name); ?></td>
                            <td style="text-align:right;">
                                <form action="<?php echo e(route('dokumenmahasiswa.validasikk', $dokumen[0]->nik)); ?>"
                                    method="POST">
                                    <?php echo e(csrf_field()); ?>
                                ...
                                <form action="<?php echo e(route('dokumenmahasiswa.tolakvalidasikk', $dokumen[0]->nik)); ?>"
                                    method="POST">
                                    <?php echo e(csrf_field()); ?>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button
                                    class="btn <?php echo e($wajib->dokumen_wajib_status == 'Y' ? 'btn-success' : 'btn-danger'); ?>"><?php echo e($wajib->dokumen_wajib_status); ?></button>
                            </td>
                            <td><?php echo e($ktp->admin()->first()->name); ?></td>
                            <td style="text-align:right;">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button
                                    class="btn <?php echo e($pendukung->dokumen_pendukung_status == 'Y' ? 'btn-success' : 'btn-danger'); ?>"><?php echo e($pendukung->dokumen_pendukung_status); ?></button>
                            </td>
                            <td><?php echo e($ktp->admin()->first()->name); ?></td>
                            <td style="text-align:right;">
                                <form
                                    action="<?php echo e(route('dokumenmahasiswa.validasidokumenpendukung', $dokumen[0]->nik)); ?>"
                                    method="POST">
                                    <?php echo e(csrf_field()); ?>
                ...
                <form action="<?php echo e(route('dokumenmahasiswa.updateketerangan', $validasi[0]->nik)); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" class="form-control" id="keterangan" cols="30"
                            rows="10"><?php echo e($validasi[0]->keterangan == '' ? '' : $validasi[0]->keterangan); ?></textarea>
                    </div>
