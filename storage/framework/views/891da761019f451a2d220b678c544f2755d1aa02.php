...
<head>
    ...
    <title>Change Password - Universitas Muhammadiyah Kota Jambi</title>
</head>
                        ...
                        <div class="card mt-5 mt-lg-0">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="text-center"> <span>UBAH PASSWORD</span>
                                        <hr />
                                        ...
                                        <div class="form-body">
                                            <form class="row g-3" method="POST" action="<?php echo e(route('changePassword', $data->email)); ?>">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="col-12">
                                                    <div class="d-grid">
                                                        <button type="submit" class="btn btn-primary"><i
                                                                class="bx bxs-lock-open"></i>Ubah Password</button>
                                                    </div>
                                                </div>
                                                <div class="col-md-6"> <a href="<?php echo e(route('login')); ?>">Kembali Ke
                                                        Login</a>
                                                </div>
                                                <div class="col-md-6 text-end"><a href="<?php echo e(route('register')); ?>">Daftar
                                                        / Register</a>
                                                </div>
                                            </form>
                                        </div>
